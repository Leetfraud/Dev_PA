...
export default function Sidebar({ active, onNavigate, screens, onLogout }) {
  return (
    <aside
    ...
    >
      ...
      <div className="p-2 border-t border-white/10">
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-500 hover:text-red-400 hover:bg-red-400/10 transition-all duration-150"
        >
